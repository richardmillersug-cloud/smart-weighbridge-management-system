...
<div class="flex min-h-screen">
    ...
    <aside class="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-steel-700/60 bg-carbon-900/95 lg:flex">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4">
            ...
            @canany(['users.view', 'settings.manage', 'cloud-sync.manage'])
            ...
            @can('cloud-sync.manage')
            <a href="{{ route('cloud-sync.index') }}" class="sidebar-link {{ request()->routeIs('cloud-sync.*') ? 'sidebar-link-active' : '' }}">
                <svg class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 0 0 1.303-7.306A4.502 4.502 0 0 0 18.75 3.75H15.75A4.5 4.5 0 0 0 11.25 9v6a3 3 0 0 1-3 3H2.25Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m0 0-3-3m3 3 3-3"/></svg>
                Cloud Sync
            </a>
            @endcan
        </nav>
